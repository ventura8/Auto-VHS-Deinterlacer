...
def ad():
    """
    Lazy import fixture for auto_deinterlancer to ensure coverage measurement
    starts before the module is first imported.
    """
    ...
    # This ensures that coverage captures the top-level execution
