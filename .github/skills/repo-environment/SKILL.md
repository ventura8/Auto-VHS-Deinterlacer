...
description: "Use when you need to install, repair, or understand the Auto-VHS-Deinterlacer Python environment."
---
...
2. Install or repair dependencies in the repository venv.
3. Validate the environment with the repo's quality commands.
4. Use the local pipeline if the change affects setup or execution.
