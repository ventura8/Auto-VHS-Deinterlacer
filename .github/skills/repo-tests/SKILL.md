---
name: repo-tests
description: "Use when you need to add, fix, or validate tests for Auto-VHS-Deinterlacer."
---
...
2. Fix the test or implementation in the same area.
3. Re-run the same focused pytest command.
4. Expand to the full suite when the targeted check passes.
