---
name: repo-quality
description: "Use when you need to validate, repair, or extend Auto-VHS-Deinterlacer with lint, test, and coverage workflows."
---
...
2. Fix the code or configuration without adding suppressions.
3. Re-run the narrowest relevant check.
4. Expand to the repo-wide quality commands when the targeted check passes.
