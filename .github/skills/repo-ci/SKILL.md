...
## name: repo-ci description: "Use when you need to update GitHub Actions or the local pipeline for Auto-VHS-Deinterlacer."
...
1. Run the repo's lint checks before the test pipeline.
1. Validate any command change locally.
1. Confirm the workflow still reflects the repository's current package layout.
