...
- [Project Overview & Directory Structure](docs/project_overview.md)
  - General project goals, modes, and file organization.
- [Key Logic & Pipeline](docs/pipeline_logic.md)
  - Detailed explanation of the 4-step hardware-aware pipeline.
- [Hardware Optimization](docs/hardware_optimization.md)
  - Auto-detection logic, profiles (ULTRA/HIGH/LOW), RAM scaling (>32GB), and CPU scaling.
- [Configuration](docs/configuration.md)
  - `config.yaml` settings and logic.
- [UI Standards](docs/ui_standards.md)
  - Specifications for the "Studio Reference" CLI aesthetic.
...
#### Workflow
1. **Auto-fix with autopep8**: `autopep8 --in-place --aggressive --aggressive <file.py>`
