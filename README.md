...
- **RAM**: "High-Performance Profile" active for systems with **>32GB RAM** (allocates up to 50% system RAM for smooth 4K/UHD processing).
...
* **Smart-Drift Correction:** Enabled by default. Uses adaptive thresholding (absolute 15ms + relative 0.01%) to distinguish between true clock skew and container metadata jitter.
* **Lossless Audio Workflow:** Automatically upgrades defaults to **PCM** when using ProRes, ensuring an archival-grade, bit-perfect audio stream.
